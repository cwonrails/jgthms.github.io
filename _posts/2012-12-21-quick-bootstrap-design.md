...
![Boostrap Hero](/i/bootstrap-hero.png)
...
![Paper colors](/i/paper-colors.png)
...
As I said earlier, if there's a color palette you like, try to use it. There was this [Nike ad](/i/nike-ad.jpg) that I really liked. It's full of different colors and gradients, but I just picked a few of them and created a 8-color palette out of it.
