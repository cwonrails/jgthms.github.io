...
To zoom in with Firefox, you need to type 'Command +'. It's probably easy on a QWERTY but it's impossible with an AZERTY: the '+' sign requires pressing the Shift button. So of I try typing 'Command Shift +' or 'Command =' (which is the sign below the '+' one), it doesn't work (and might even trigger another event).
